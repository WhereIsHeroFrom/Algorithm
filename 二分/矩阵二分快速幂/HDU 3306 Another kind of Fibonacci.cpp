...
void constructMatrix(LL X, LL Y) {
	LL X2 = X*X % MOD;
	LL Y2 = Y*Y % MOD;
	LL XY = X*Y % MOD;
	
	AArray[0][0] = 1; AArray[0][1] = X2; AArray[0][2] = 2 * X * Y % MOD; AArray[0][3] = Y2; 
	AArray[1][0] = 0; AArray[1][1] = X2; AArray[1][2] = 2 * X * Y % MOD; AArray[1][3] = Y2; 
	AArray[2][0] = 0; AArray[2][1] = X % MOD; AArray[2][2] = Y % MOD; AArray[2][3] = 0; 
	AArray[3][0] = 0; AArray[3][1] = 1; AArray[3][2] = 0; AArray[3][3] = 0;  
